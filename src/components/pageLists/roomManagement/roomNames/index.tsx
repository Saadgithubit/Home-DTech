...
const RoomsNameList: React.FC<RoomsNameListProps> = ({ roomsNamesList, itemsPerPage = 3 }) => {
    ...
    const displayedList = roomsNamesList.slice(firstIndex, lastIndex);
    const totalPages = Math.ceil(roomsNamesList.length / itemsPerPage);
